    ...
    <div className="min-h-screen bg-black text-white flex justify-center font-['TwitterChirp',system-ui,sans-serif]">
      <div className="flex w-full max-w-[1265px]">
        ...
        <div className="w-[88px] xl:w-[275px] shrink-0 flex flex-col items-center xl:items-start px-2 xl:px-4 py-2 sticky top-0 h-screen">
          ...
          <nav className="flex flex-col gap-1 w-full">
            {navItems.map(({ icon, label }) => (
              ...
              >
                ...
                {label === 'Home' && (
                  <span className="hidden xl:block ml-auto bg-[#1d9bf0] text-white text-xs font-bold px-2 py-0.5 rounded-full">
                    🔒
                  </span>
                )}
              </button>
          ...
          <button
            onClick={() => setShowModal(true)}
            className="mt-4 xl:hidden flex items-center justify-center bg-[#1d9bf0] hover:bg-[#1a8cd8] text-white font-bold w-14 h-14 rounded-full transition"
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white">
              <path d="M23 3c-6.62-.1-10.38 2.421-13.05 6.03C7.29 12.61 6 17.331 6 22h2c0-4.339 1.148-8.33 3.95-11.03C14.28 8.322 17.721 6.99 23 7V3z"/>
              <path d="M15 3H1v16l4.233-4.233c.27 1.049.944 2.527 2.267 3.233H9c.006-3.57 1.218-7.584 4-9.585V3z"/>
            </svg>
          </button>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-1 min-w-0">
                    <span className="font-bold text-[15px] truncate hover:underline cursor-pointer">{post.user}</span>
                  ...
                  <button className="text-gray-500 hover:text-[#1d9bf0] hover:bg-[#1d9bf0]/10 p-2 rounded-full transition flex-shrink-0">
                ...
                <div className="flex items-center justify-between mt-3 text-gray-500 max-w-[425px]">
                  ...
                  >
                    <span className={`p-2 rounded-full transition group-hover:bg-pink-500/10`}>
        ...
        <div className="hidden lg:flex flex-col w-[350px] shrink-0 px-6 py-3 sticky top-0 h-screen overflow-y-auto gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-900 rounded-full py-3 pl-12 pr-4 text-[15px] outline-none focus:ring-2 focus:ring-[#1d9bf0] focus:bg-black transition"
            />
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-4">
            ...
            <button className="bg-[#1d9bf0] hover:bg-[#1a8cd8] text-white font-bold py-2.5 px-5 rounded-full transition text-[15px]">
              Subscribe
            </button>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl overflow-hidden">
            ...
            <button className="w-full text-[#1d9bf0] text-[15px] p-4 text-left hover:bg-white/5 transition">
              Show more
            </button>
          </div>
            ...
            <div className="flex gap-3 px-4 pb-4">
              ...
              <div className="flex-1">
                ...
                {newPostText.length > 0 && (
                  <button className="text-[#1d9bf0] text-sm font-bold flex items-center gap-1 hover:bg-[#1d9bf0]/10 px-3 py-1 rounded-full transition mb-2">
                    🌐 Everyone can reply
                  </button>
                )}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {newPostText.length > 0 && (
                      <div className="flex items-center gap-3">
                        ...
                        <button className="w-8 h-8 border border-gray-700 rounded-full flex items-center justify-center text-[#1d9bf0] hover:bg-[#1d9bf0]/10 transition text-lg font-bold">
                          +
                        </button>
                      </div>
                    )}
...
// ✅ Format time like X: "2h", "Apr 10", etc.
